...
2. Use the approved design artifact. Keep the approved Unified Review Workbench design as the source of truth; do not create a parallel `src/design/` source.
