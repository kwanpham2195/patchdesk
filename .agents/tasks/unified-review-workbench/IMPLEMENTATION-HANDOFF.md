...
- `700078f` fixes PR Overview disclosure interaction, `98daeff` adds the persistent Review draft dock, and `c39a76e` adds the exact publication preview/confirmation dialog.
- The full gate now passes at 105 files/655 tests, plus lint, typecheck, build, and diff check.
