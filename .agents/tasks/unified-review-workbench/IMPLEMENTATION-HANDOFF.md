...
- **Insights — partially finished.** Durable storage, bounded Analysis authority, cancellable independent runs, protected lifecycle routes, polling, cancellation, orphan recovery, and draft-independent Analysis completion are implemented. Remaining: finish Finding disposition APIs, build the canonical Analysis and Walkthrough readers, remove legacy reader ownership, and complete Insights/live acceptance. Main checkpoints: `6e79abe`, `48bdecf`, `e2d8ba4`, `eae7cd4`, `00869ea`, `16d9363`, `715356c`, `05c0bbe`, `4b899d0`, `2134496`, `0aa147a`, `3600fb8`.
...
- Fresh automated evidence after the UI cleanup: `pnpm lint`, `pnpm typecheck`, `pnpm test -- --run` (95 files/623 tests), `pnpm build`, `pnpm exec playwright test` (60 passed), and `git diff --check` passed.
