...
- Analysis now exposes an explicit Save as Review draft completion choice; the action is passed through the run contract and completion handler, while publish remains authorization-backed.
