...
- Analysis now exposes explicit completion choices; Save as Review draft and Seed and open preview are passed through the run contract and completion handler, while publish remains authorization-backed.
- The full gate passes at 105 files/655 tests, plus lint, typecheck, build, and diff check.
