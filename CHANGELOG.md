...
- Added a **Flow** block to Brief: up to two diff-styled trees of a runtime sequence, with each step marked added, removed, or unchanged, a hunk citation required on every changed step, and a Copy as diff action; a Brief retained before this change has no Flow.
