...
- Fixed Reach reporting a changed file as untested when its test file uses a different separator or sits beside it, and made the surface flags recognise Go-style paths (pkg/…/v1, internal/adapter, repo, cmd).
