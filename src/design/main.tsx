...
if (scenario?.id === "settings-recovery" || scenario?.id === "dialog-clear-local-data") window.localStorage.setItem("patchdesk.destination", "settings");
...
// visual baseline.
if (scenario?.id === "inbox-default" || scenario?.id === "inbox-recovery-states") {
