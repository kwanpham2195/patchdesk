...
export function MergeConfirmationDialog(props: {
  ...
  readonly onMerge: (method: MergeMethod) => Promise<{ readonly mergeCommitSha?: string }>;
}): React.JSX.Element {
