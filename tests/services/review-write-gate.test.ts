...
import { createReview, markDetectedUpdate } from "../../src/domain/review";
...
describe("ReviewWriteGate", () => {
  it("requires represented, matching, undetected state", async () => {
    ...
    const marked = markDetectedUpdate(restored.value, { detectedAt: at, reason: "checks" }, restored.value.updatedAt);
