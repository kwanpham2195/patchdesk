...
- `manual:`
  - Run a Brief on a real PR with a runtime-sequence change: the four blocks must appear in order — Flow, Shape, Start here, Reach — with Scope and Provenance in the side column.
