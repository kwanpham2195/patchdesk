...
> **Status: Superseded.** The ADR "Authorize Finding review commands from Analysis" allows Analysis only to prefill Finish review after a Finding-backed GitHub pending review exists; it never seeds a local draft.
