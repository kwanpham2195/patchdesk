...
- A workspace profile owns GitHub host and account, workspace roots, rule paths, watched repositories, and the active-profile choice. It contains no credential.
