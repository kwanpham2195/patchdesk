...
**Brief.** The latest successful short answer to what the change is for and where to start reading. Its fixed blocks are Goal, Description vs diff when applicable, Shape, Reach, and Start here.
