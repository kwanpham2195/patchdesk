...
**Local persistence and recovery.** Retained Analysis and confirmed dismissal dispositions are saved. Pending-review receipts and unknown outcomes use the Review's durable recovery state. Verification ticks are saved with the retained Analysis. The Lower severity disclosure is not saved.
