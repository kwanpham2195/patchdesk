...
When generation returns zero Findings, the Findings card is titled No findings and says "Nothing to add or dismiss." Generated Markdown keeps its original structure while the reader applies safe rendering.
