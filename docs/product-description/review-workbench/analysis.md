...
Analysis opens in the Insights slot for the represented Review session. Above the reader, the shared Insight header says Current or Outdated, how long ago the Analysis was retained, and the provider and model, with a secondary Regenerate button while the Insight is current.
