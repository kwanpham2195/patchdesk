...
- **Review status.** One line each for Brief, Analysis, and Walkthrough, with the Insight's icon and its status: Not generated, Running, Generated, Outdated, or Failed. The Insight tab strip owns those Insights ([Brief](brief.md#arrive)).
