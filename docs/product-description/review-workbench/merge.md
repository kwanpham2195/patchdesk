...
- **Merge readiness.** Its label reads Ready to merge, Warnings, Blocked, or Unknown, and its body holds the reasons, warnings, and the merge command. On a merged or closed Review it reads Merged or Closed, and its body says only "Merge readiness no longer applies."; no blocker cards, draft toggle, base-branch change, or merge command appear.
